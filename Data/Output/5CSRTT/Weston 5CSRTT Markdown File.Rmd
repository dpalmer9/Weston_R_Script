---
title: "Weston 5CSRTT ANOVA Results"
...
## Acquisition Training: 4 Second Phase
### Number of Sessions
  This ANOVA was a 2 (Sex) x 2 (Genotype) x 2 (Test Site) design.

#### APP/PS1 Mice
```{r}
acq.4.anova$APP$Sessions
```

#### 5xFAD Mice
```{r}
acq.4.anova$TG5x$Sessions
```

#### APP/PS1 Mice
```{r}
acq.4.anova$TG3x$Sessions
```

## Acquisition Training: 2 Second Phase
### Number of Sessions
  This ANOVA was a 2 (Sex) x 2 (Genotype) x 2 (Test Site) design.

#### APP/PS1 Mice
```{r}
acq.2.anova$APP$Sessions
```

#### 5xFAD Mice
```{r}
acq.2.anova$TG5x$Sessions
```

#### APP/PS1 Mice
```{r}
acq.2.anova$TG3x$Sessions
```

## Probe Trial Data
### Total Session Length
  This ANOVA was a 4 (Stimulus Length) x 3 (Age) x 2 (Sex) x 2 (Genotype) x 2 (Test Site) Split-Plot design.

#### APP/PS1 Mice
```{r}
summary(probe.anova$APP$TotalTime, multivariate=FALSE)
```

#### 5xFAD Mice
```{r}
summary(probe.anova$TG5x$TotalTime, multivariate=FALSE)
```

#### 3xTG Mice
```{r}
summary(probe.anova$TG3x$TotalTime, multivariate=FALSE)
```
...
#### APP/PS1 Mice
```{r}
summary(probe.anova$APP$TotalTrials, multivariate=FALSE)
```

#### 5xFAD Mice
```{r}
summary(probe.anova$TG5x$TotalTrials, multivariate=FALSE)
```

#### 3xTG Mice
```{r}
summary(probe.anova$TG3x$TotalTrials, multivariate=FALSE)
```
...
#### APP/PS1 Mice
```{r}
summary(probe.anova$APP$Accuracy, multivariate=FALSE)
```

#### 5xFAD Mice
```{r}
summary(probe.anova$TG5x$Accuracy, multivariate=FALSE)
```

#### 3xTG Mice
```{r}
summary(probe.anova$TG3x$Accuracy, multivariate=FALSE)
```
...
#### APP/PS1 Mice
```{r}
summary(probe.anova$APP$Omission, multivariate=FALSE)
```

#### 5xFAD Mice
```{r}
summary(probe.anova$TG5x$Omission, multivariate=FALSE)
```

#### 3xTG Mice
```{r}
summary(probe.anova$TG3x$Omission, multivariate=FALSE)
```
...
#### APP/PS1 Mice
```{r}
summary(probe.anova$APP$Premature, multivariate=FALSE)
```

#### 5xFAD Mice
```{r}
summary(probe.anova$TG5x$Premature, multivariate=FALSE)
```

#### 3xTG Mice
```{r}
summary(probe.anova$TG3x$Premature, multivariate=FALSE)
```
...
#### APP/PS1 Mice
```{r}
summary(probe.anova$APP$Perseverative, multivariate=FALSE)
```

#### 5xFAD Mice
```{r}
summary(probe.anova$TG5x$Perseverative, multivariate=FALSE)
```

#### 3xTG Mice
```{r}
summary(probe.anova$TG3x$Perseverative, multivariate=FALSE)
```
...
#### APP/PS1 Mice
```{r}
summary(probe.anova$APP$CorrectLat, multivariate=FALSE)
```

#### 5xFAD Mice
```{r}
summary(probe.anova$TG5x$CorrectLat, multivariate=FALSE)
```

#### 3xTG Mice
```{r}
summary(probe.anova$TG3x$CorrectLat, multivariate=FALSE)
```
...
#### APP/PS1 Mice
```{r}
summary(probe.anova$APP$RewardLat, multivariate=FALSE)
```

#### 5xFAD Mice
```{r}
summary(probe.anova$TG5x$RewardLat, multivariate=FALSE)
```

#### 3xTG Mice
```{r}
summary(probe.anova$TG3x$RewardLat, multivariate=FALSE)
```
