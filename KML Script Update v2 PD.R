...
ggplot(data=graphing.data.cast,aes(x=as.numeric(as.character(graphing.data.cast$Time)),y=graphing.data.cast$Accuracy,group=as.factor(graphing.data.cast$Group.1))) + 
